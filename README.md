...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Index Iniciando..",
   LoadingSubtitle = "by Theuxzzzy",
   ShowText = "Index Hub", -- for mobile users to unhide rayfield, change if you'd like
...
local MainTab = Window:CreateTab("Main", 9405923687) -- Title, Image
